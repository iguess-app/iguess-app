export default {
  ...
  signUpInputErrorEmpty: 'Não pode ser em branco',
  signUpInputErrorName: 'O nome tem que ter 3 ou mais caracteres',
  signUpInputErrorUsername: 'O username tem que ter 4 ou mais caracteres',
