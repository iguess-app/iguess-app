export default {
  ...
  myLeaguesSubTitle:
    'Here you can compete with your friends to see who has the best guesses',
  emptyLeaguesText: 'You do not have any league yet',
  createLeagueText: 'Create League',
  exitLeagueTitle: 'Exit league ?',
  confirmExitLeagueText: 'Are you sure you want to leave the league {{text}} ?',
  exitText: 'Exit',
  cancelText: 'Cancel',
  removeText: 'Remove',
  addFriendText: 'Add Friend',
  exitLeagueText: 'Quit League',
  youText: 'You',
  createLeagueTitle: 'Create Leagues',
  createLeagueSubTitle: 'Create a league and call your friends to compete',
  nameOfLeagueLabel: 'Name of your league',
  continueText: 'Continue',
  searchUserText: 'Search by @user',
  addFriendsTitle: 'Add Friends',
  addText: 'Add',
  createMyleagueText: 'Create My League',
  addeFriendsTitle: 'Friends Added',
